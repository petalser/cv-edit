    ...
    <main className="container">
      ...
      <section className="row m-auto">
        ...
        <p className="text-center">
          У розробці приблизно з 2020-2021рр. Наразі поєдную парт-тайм розробку
          з роботою поза IT. Шукаю посаду фронт-енда (або навіть фул-стек
          трейні) на повний день. Маю інвалідність (бронь від призову,вільний
          виїзд/в&#39;їзд). Також це плюс з точки зору КЗпП
        </p>
      </section>
      ...
      <section>
        <div className="row">
          <div className="col-md-12 text-center">
            <h4>Проєкти</h4>
            <p>
              Протягом останніх кількох років я брав участь у різних проєктах, а
              також побудував кілька власноруч. Наприклад:
            </p>
          </div>
        </div>
        ...
        <div className="row d-flex">
          ...
          <div className="col">
            ...
            <p className="card-text">
              Побудовано з React.js та Sass у чорно-білому стилі. Пошук новин з
              вибором мови.
              <br />
              <a
      ...
      <section>
        ...
        <p>
          <strong>Нерелевантний досвід: </strong> Я маю 10+ років досвіду роботи
          як у командах різного розміру, так і соло. Маю досвід керування
          персоналом, але подібні ролі не розглядаю.
        </p>
        <p>
          <strong>Web Developer</strong> Freelance (2022-сьогодні)
        </p>
        <li className="mb-2">
          Розробка веб-додатків різноманітного маштабу від крихітних лендінгів
        ...
        <li className="mb-2">
          Розробка дрібного ПЗ під індивідуальні потреби клієнта: складні
          калькулятори, боти, скрипти для обробки/сортування даних, тощо.
        </li>
      </section>
    </main>
  );
